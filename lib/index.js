...
Mixpanel.prototype.identify = function(identify) {
  ...
  var appendPeopleProperties = this.options.appendPeopleProperties;
  ...
  if (!is.empty(appendPeopleProperties)) {
    window.mixpanel.people.append(pick(appendPeopleProperties, identify.traits()));
  }
};
